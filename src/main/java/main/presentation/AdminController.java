...
public class AdminController {
    ...
    @RequestMapping(value = "/adminView", method = RequestMethod.GET, params = "redirect=toBookCrud")
    public ModelAndView switchToBookCrud(Principal principal)
    {
        return new ModelAndView("crud_user");
    }

    @RequestMapping(value = "/adminView", method = RequestMethod.GET, params = "redirect=toUserCrud")
